...
export default function AdminLogin() {
  ...
  // Quick demo credentials loader for Admin/Safety Officer
  function fillDemoCredentials() {
    setEmail("admin@plant.com");
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      const message = err instanceof Error ? err.message : "Invalid admin credentials or network issue.";
      setError(message);
    } finally {
      setLoading(false);
    }
  ...
  // Exact semantic color tokens requested
  const theme = isDark
    ? {
        bg: "#0b0f17",
        surface: "#131b26",
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "center", marginBottom: "24px" }}>
            ...
            >
              Authorized console for Safety Officers, Maintenance & Admins
            </p>
          </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              ...
              <div style={{ position: "relative", display: "flex", alignItems: "center" }}>
                ...
                <input
                  ...
                  placeholder="e.g. admin@plant.com"
                  style={{
                    width: "100%",
          ...
          >
            ...
            >
              <span>Email: <code>admin@plant.com</code></span>
